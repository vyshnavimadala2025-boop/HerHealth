...
import { deleteSleepEntry } from '@/features/sleepIntelligence/sleepService'
import type { SleepEntry } from '@/features/sleepIntelligence/types'

interface DeleteSleepEntryDialogProps {
  entry: SleepEntry
  onDeleted: () => void
}

function DeleteSleepEntryDialog({ entry, onDeleted }: DeleteSleepEntryDialogProps) {
...
export default DeleteSleepEntryDialog
