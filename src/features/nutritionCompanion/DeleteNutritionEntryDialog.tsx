...
import { deleteNutritionEntry } from '@/features/nutritionCompanion/nutritionService'
import type { NutritionEntry } from '@/features/nutritionCompanion/types'

interface DeleteNutritionEntryDialogProps {
  entry: NutritionEntry
  onDeleted: () => void
}

function DeleteNutritionEntryDialog({ entry, onDeleted }: DeleteNutritionEntryDialogProps) {
  ...
  return (
    <AlertDialog open={open} onOpenChange={(next) => !isDeleting && setOpen(next)}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>Delete this nutrition entry?</AlertDialogTitle>
...
export default DeleteNutritionEntryDialog
