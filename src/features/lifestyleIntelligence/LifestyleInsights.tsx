...
import type { LifestyleInsight } from '@/features/lifestyleIntelligence/lifestyleInsightEngine'
 ...
 */
function LifestyleInsights({ status, insights }: LifestyleInsightsProps) {
  return (
    <Card>
      <CardHeader>
        <div className="flex items-center gap-2">
          ...
          <CardTitle>AI Lifestyle Insights</CardTitle>
        </div>
      </CardHeader>
